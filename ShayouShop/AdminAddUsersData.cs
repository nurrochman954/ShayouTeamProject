...
namespace ShayouShop
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\LENOVO\Documents\ShayouShopDb.mdf;Integrated Security=True;Connect Timeout=30");
